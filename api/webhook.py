...
firebase_admin.initialize_app(cred, {'storageBucket': 'minidemo-28f39.appspot.com'})
db = firestore.client()
bucket = storage.bucket()

def  generate_start_keyboard():
    keyboard = InlineKeyboardMarkup()
    keyboard.add(InlineKeyboardButton("Open My Minidemi App", web_app=WebAppInfo(url="https://relaxed-raindrop-f44f11.netlify.app/")))
    return keyboard
        ...
        if not user_doc.exists:
            ...
            if photos and photos.total_count > 0 and photos.photos:
                ...
                if response.status_code == 200:
                    ...
                    blob.upload_from_string(response.content, content_type='image/jpg')
